...
// --- Carousel Context ---
type CarouselApi = ReturnType<typeof useEmblaCarousel>[1] | undefined;
  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4">
      ...
      >
        ...
        <CarouselPrevious className="bg-foreground/10 border-0 hover:bg-foreground/20 text-foreground" />
