...
function PhotoCard({
  ...
  return (
    <div
      className={cn(
        "overflow-hidden rounded-xl cursor-pointer flex-shrink-0 transition-opacity duration-400 ring-2 ring-transparent",
        className,
        isDimmed ? "opacity-60" : "opacity-100",
        isActive && "ring-primary/40 shadow-lg shadow-primary/10"
      )}
